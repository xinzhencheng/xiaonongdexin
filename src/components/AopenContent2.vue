 ...
 * @LastEditTime: 2019-12-05 19:23:15
 * @Description: 
 -->
<template>
<div class="waibox">
    ...
    <div class="pass" @click="ok()" v-if="isShow">微信支付￥299.0</div>
    <div class="pass" @click="ok()" v-if="Show">支付宝支付￥299.0</div>
</div>
</template>
<script>
export default {
    ...
    created(){
        // console.log(this.$store.state.zs);
    }
}
</script>
